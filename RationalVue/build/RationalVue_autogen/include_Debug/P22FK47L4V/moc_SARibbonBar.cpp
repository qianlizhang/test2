...
#include "gui/MenuBarZone/SARibbonBar.h"
...
void SARibbonBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SARibbonBar::applitionButtonClicked)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SARibbonBar::currentRibbonTabChanged)) {
                *result = 1;
                return;
            }
        }
...
void *SARibbonBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SARibbonBar.stringdata0))
        return static_cast<void*>(const_cast< SARibbonBar*>(this));
